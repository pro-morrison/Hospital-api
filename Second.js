...
// Define MongoDB schema and model (Patient and Encounter)
...
const encounterSchema = new mongoose.Schema({
  patientId: String,
  dateAndTime: Date,
  typeOfEmergency: String // 'emergency', 'opd', 'special case', etc.
});
...
// Functionality 5: Start a visitation encounter for a patient
